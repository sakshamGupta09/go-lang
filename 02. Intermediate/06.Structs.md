...
- It pulls out the struct values to the outer struct level. So, all the sub properties of embedded struct can be directly accesses by outer struct as if it were defined here.
