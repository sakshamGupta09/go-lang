...
- Errors are expencted. We are doing an operation and we are aware that this operation might result in an error. Like connecting to a DB or m aking a network call.
