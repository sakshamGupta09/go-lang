...
- We need to create a stack data structure which can support different data types like integers, floats, strings, characters or a boolean.
- We need to create a stack which supports multiple data types. We cannot define the type while defining stack. We need a way to pass the type when struct is instantiated.
