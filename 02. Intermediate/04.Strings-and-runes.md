...
- Every character in this world(in any language or emojis) have a unicode number.
- UTF-8 encoding is a mechanism which tells machines how many bytes will it take to store this character whose unicode number is this and how it will be stored in memory.
...
- Strings are character arrays so we can perform all array operations. When we access value we get the ASCII values.
...
- Think of them as instructions that say “print this value like this”.
