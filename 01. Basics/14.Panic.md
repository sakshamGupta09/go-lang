...
- Errors are expected. I am going to do a task which may give an error. I am aware of that and I can handle that. Like connecting to a DB, making a network call.
- Panic is for bugs and impossible states that should never happen.
