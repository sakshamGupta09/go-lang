...
- Sometimes after performing a long task we forget to write cleanup in the end. With defer we can write cleanup logic even before starting a long task and the execution will be postponed automatically.
