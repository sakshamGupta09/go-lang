...
- We have a function. From this function, we are calling another function. But that another function will be executed only when the first function completes or panics.
