...
- We need to create a stack data structure which can support different data types like integers, floats, strings, characters or booleans.
- We cannot define the type while defining stack so we keep a placeholder type. We need a way to pass the type when struct is instantiated.
...
- Generics lets us define functions and types that can work with multiple data types.
...
- As soon as we declare the name of our type or function we need to define this placeholder [T any]
